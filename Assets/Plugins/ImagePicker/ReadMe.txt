...
**: needs further testing to make sure it works on all devices, still need <uses*-permission android:name="android.permission.READ_EXTERNAL_STORAGE" /> to access camera files.
